...
mlflow.set_tracking_uri("https://dagshub.com/juna-99/Water-Portability-Prediction-MLOps.mlflow")   # Registry URI for model management

# Load the dataset from CSV file and split into training and testing sets
data = pd.read_csv(r"data\raw\water_protability.csv")
