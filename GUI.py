...
alias = "Production"  # Use alias instead of deprecated stages
...
class PredictionApp(tk.Tk):
    ...
    def load_model(self):
        try:
            ...
            # Fetch the model version assigned to the alias (Production)
            ...
            if model_version_info:
                ...
                run_id = model_version_info.run_id  # Fetching the run ID from the latest version
                ...
                messagebox.showerror("Error", f"No model found with alias '{alias}'.")
                return None
